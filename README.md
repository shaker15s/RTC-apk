...
> خدمات RTC التدريبية مجانية وقائمة على المتطوعين. الموقع الرسمي المعتمد داخل التطبيق: [rtc-kohl.vercel.app](https://rtc-kohl.vercel.app/). البيانات التشغيلية داخل التطبيق تُدار من قاعدة البيانات لأن المواعيد والفروع تتغير.
