/**
 * Bilingual Engine for Masar RTC Native Mobile.
...
export const STRINGS = {
  ar: {
    ...
    active: 'نشط',
    inactive: 'غير نشط',
    enterCode: 'أدخل رمز الحضور',
    scanQr: 'امسح رمز QR',
    reasonLabel: 'سبب العذر',
    uploadProof: 'إرفاق مستند العذر (اختياري)',
    rateCourse: 'تقييم الدورة',
    addNote: 'إضافة ملاحظة خاصة',
    startSession: 'بدء الجلسة',
    closeSession: 'إغلاق الجلسة',
    sessionReport: 'تقرير المحاضرة',
    hotlineCta: 'الاتصال بالخط الساخن 19450',
  ...
  en: {
    ...
    scanQr: 'Scan QR Code',
    reasonLabel: 'Reason',
    uploadProof: 'Attach proof document (optional)',
    rateCourse: 'Rate Course',
    addNote: 'Add Private Note',
    startSession: 'Start Session',
    closeSession: 'Close Session',
    sessionReport: 'Session Report',
    hotlineCta: 'Call hotline 19450',
