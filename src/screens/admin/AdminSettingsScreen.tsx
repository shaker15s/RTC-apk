/**
 * Admin Settings & Profile Screen (a-settings)
 * Preferences, dark mode toggle, cache reset, and admin sign-out.
 */
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <CustomCard style={styles.profileCard}>
          <View style={styles.profileHeader}>
            <View style={[styles.avatarWrap, { borderColor: colors.red }]}>
              <ShieldCheck color={colors.red} size={36} />
            </View>
        ...
        <CustomCard style={styles.menuCard}>
          ...
          <TouchableOpacity activeOpacity={0.7} onPress={handleRefreshCache} style={styles.menuItem}>
            <View style={styles.menuLeft}>
